...
def has_Havel_Hakimi_property(g, v):
    ...
    A vertex has the Havel-Hakimi property if it has maximum degree and the minimum degree of its neighbours is at least the maximum degree of its non-neigbors. Graphs with the strong Havel-Hakimi property, M. Barrus, G. Molnar, Graphs
...
def is_bad(g):
    """
    Return whether a Graph g is bad or not.
    """
